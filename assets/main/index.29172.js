window.__require = function e(t, n, r) {
  ...
  BgShopItem: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "92eacPVmfxKy7C0qJX1RlZ0", "BgShopItem");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var BgShopPanel_1 = require("./BgShopPanel");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var BgShopItem = function(_super) {
      __extends(BgShopItem, _super);
      function BgShopItem() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.checkIcon = null;
        _this._bgIndex = 0;
        _this._isChecked = false;
        return _this;
      }
      Object.defineProperty(BgShopItem.prototype, "bgIndex", {
        get: function() {
      ...
      Object.defineProperty(BgShopItem.prototype, "isChecked", {
        get: function() {
          return this._isChecked;
        },
        set: function(isChecked) {
          this._isChecked = isChecked;
          this.checkIcon.active = this._isChecked;
        },
        enumerable: false,
        configurable: true
      });
      BgShopItem.prototype.onLoad = function() {
        this.node.on(cc.Node.EventType.TOUCH_END, this.onItemTouch, this);
      };
      BgShopItem.prototype.onItemTouch = function(event) {
        var bgShopPanel = this.node.parent.getComponent(BgShopPanel_1.default);
        bgShopPanel.setBg(this.bgIndex, this.node.color);
        bgShopPanel.updateSelectedItem();
      };
      BgShopItem.prototype.start = function() {};
      __decorate([ property(cc.Node) ], BgShopItem.prototype, "checkIcon", void 0);
      BgShopItem = __decorate([ ccclass ], BgShopItem);
      return BgShopItem;
    }(cc.Component);
    exports.default = BgShopItem;
    cc._RF.pop();
  }, {
    "./BgShopPanel": "BgShopPanel"
  } ],
  BgShopPanel: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "62bb3UzYuZHvqZ0Ss1SnM6G", "BgShopPanel");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var BgShopItem_1 = require("./BgShopItem");
    var Global_1 = require("./Global");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var BgShopPanel = function(_super) {
      __extends(BgShopPanel, _super);
      function BgShopPanel() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.itemList = [];
        _this._currentBgIndex = -1;
        return _this;
      }
      BgShopPanel.prototype.onLoad = function() {
        for (var i = 0; i < this.node.children.length; i++) {
          var bgItem = this.node.children[i].getComponent(BgShopItem_1.default);
          bgItem.bgIndex = i;
          this.itemList.push(bgItem);
        }
        this.updateSelectedItem();
      };
      BgShopPanel.prototype.updateSelectedItem = function() {
        var bgID = Global_1.Global.getInstance().userData.backgroundID;
        for (var i = 0; i < this.itemList.length; i++) this.itemList[i].isChecked = bgID === i;
      };
      BgShopPanel.prototype.setBg = function(index, color) {
        if (index === this._currentBgIndex) return;
        Global_1.Global.getInstance().inGame.setBgColor(index, color);
        this._currentBgIndex = index;
      };
      BgShopPanel.prototype.setBgById = function(index) {
        this.setBg(index, this.node.children[index].color);
      };
      BgShopPanel.prototype.start = function() {};
      BgShopPanel = __decorate([ ccclass ], BgShopPanel);
      return BgShopPanel;
    }(cc.Component);
    exports.default = BgShopPanel;
    cc._RF.pop();
  }, {
    "./BgShopItem": "BgShopItem",
    "./Global": "Global"
  } ],
  ...
  Global: [ function(require, module, exports) {
    ...
    var UserData = function() {
      ...
      Object.defineProperty(UserData.prototype, "backgroundColor", {
        get: function() {
          return this._backgroundColor;
        },
        set: function(color) {
          this._backgroundColor = color;
          cc.sys.localStorage.setItem("backgroundColor", this._backgroundColor);
        },
        enumerable: false,
        configurable: true
      });
      ...
      UserData.prototype.initFromLocalData = function() {
        ...
        this._backgroundColor = cc.sys.localStorage.getItem("backgroundColor");
        cc.log("@@@ backgroundColor : " + this._backgroundColor);
  ...
  InGame: [ function(require, module, exports) {
    ...
    var InGame = function(_super) {
      ...
      function InGame() {
        ...
        _this.bgShopPanel = null;
        _this.undoBtn = null;
        _this.undoLabel = null;
        _this.redoBtn = null;
        _this.redoLabel = null;
      ...
      InGame.prototype.onLoad = function() {
        ...
        this.bgShopPanel.setBgById(Global_1.Global.getInstance().userData.backgroundID);
        this.preloadAudio();
      };
      ...
      InGame.prototype.setBgColor = function(id, color) {
        this.mainCamera.backgroundColor = color;
        Global_1.Global.getInstance().userData.backgroundID = id;
      };
      ...
      InGame.prototype.startHint = function() {
        var _this = this;
        if (this.solution.length >= 2 && 0 === this._actionList.length && !this.hintMode) {
          this.hintMode = true;
      ...
      InGame.prototype.updateUndoRedoBtn = function() {
        ...
        this.undoLabel.string = "" + this._actionList.length;
        this.redoLabel.string = "" + this._undoActionList.length;
      };
      ...
      __decorate([ property(cc.Camera) ], InGame.prototype, "mainCamera", void 0);
      __decorate([ property(BgShopPanel_1.default) ], InGame.prototype, "bgShopPanel", void 0);
      __decorate([ property(cc.Button) ], InGame.prototype, "undoBtn", void 0);
      __decorate([ property(cc.Label) ], InGame.prototype, "undoLabel", void 0);
      __decorate([ property(cc.Button) ], InGame.prototype, "redoBtn", void 0);
      __decorate([ property(cc.Label) ], InGame.prototype, "redoLabel", void 0);
  ...
  LevelItem: [ function(require, module, exports) {
    ...
    var LevelItem = function(_super) {
      ...
      __decorate([ property(cc.Node) ], LevelItem.prototype, "bgLock", void 0);
  ...
  LevelPanel: [ function(require, module, exports) {
    ...
    var LevelPanel = function(_super) {
      ...
      LevelPanel.prototype.onEnable = function() {
      ...
      LevelPanel.prototype.onLoad = function() {
        ...
        this.numLevel = 435;
        this.numColum = 5;
        this._currentDrawRow = 0;
        this.numRow = Math.ceil(this.numLevel / this.numColum);
        this.content.height = this.numRow * (this.item.height + this.rowSpace) + this.rowSpace;
        this.drawLevelItemRows(0, 10);
      };
      LevelPanel.prototype.update = function(dt) {
        if (this._currentDrawRow >= this.numRow) return;
        this.drawLevelItemRows(this._currentDrawRow, 1);
      };
      LevelPanel.prototype.drawLevelItemRows = function(beginRow, numRow) {
        var itemDistance = this.item.width + this.columSpace;
        var beginX = (this.content.width - (this.numColum * itemDistance - this.columSpace)) / 2;
        for (var i = beginRow; i < beginRow + numRow; i++) for (var j = 0; j < this.numColum; j++) {
          var level = 0 + i * this.numColum + j;
          if (level >= this.numLevel) break;
        ...
        this._currentDrawRow = beginRow + numRow;
      };
      ...
      LevelPanel.prototype.updateActiveLevel = function() {
  ...
  SoundSlipRadioBtn: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "f9873LOwBhJyrMV1cO4oSkE", "SoundSlipRadioBtn");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var Global_1 = require("../Global");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var SoundSlipRadioBtn = function(_super) {
      __extends(SoundSlipRadioBtn, _super);
      function SoundSlipRadioBtn() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.slipNode = null;
        _this.offPos = 0;
        _this.onPos = 0;
      ...
      Object.defineProperty(SoundSlipRadioBtn.prototype, "status", {
        get: function() {
          return this._status;
        },
        set: function(value) {
          this._status = value;
          this._status ? cc.tween(this.slipNode).to(.2, {
            x: this.onPos
          }).start() : cc.tween(this.slipNode).to(.2, {
            x: this.offPos
          }).start();
          this.updateData();
        },
      ...
      SoundSlipRadioBtn.prototype.onLoad = function() {
        this.slipNode.on(cc.Node.EventType.TOUCH_START, this.onTouchSlipNode, this);
      };
      SoundSlipRadioBtn.prototype.onTouchSlipNode = function(event) {
        this.status = !this.status;
      };
      SoundSlipRadioBtn.prototype.start = function() {
        this.initData();
      };
      SoundSlipRadioBtn.prototype.initData = function() {
        this._status = Global_1.Global.getInstance().userData.sound;
        this.initUI();
      };
      SoundSlipRadioBtn.prototype.initUI = function() {
        this.status ? this.slipNode.x = this.onPos : this.slipNode.x = this.offPos;
      };
      SoundSlipRadioBtn.prototype.updateData = function() {
        Global_1.Global.getInstance().userData.sound = this.status;
      };
      __decorate([ property(cc.Node) ], SoundSlipRadioBtn.prototype, "slipNode", void 0);
      __decorate([ property ], SoundSlipRadioBtn.prototype, "offPos", void 0);
      __decorate([ property ], SoundSlipRadioBtn.prototype, "onPos", void 0);
      SoundSlipRadioBtn = __decorate([ ccclass ], SoundSlipRadioBtn);
      return SoundSlipRadioBtn;
    }(cc.Component);
    exports.default = SoundSlipRadioBtn;
    cc._RF.pop();
  }, {
    "../Global": "Global"
  } ],
  ...
  TubeShopItem: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "4bec4Fkt3RA8bQJbzliBSE4", "TubeShopItem");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var TubeShopPanel_1 = require("./TubeShopPanel");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var TubeShopItem = function(_super) {
      __extends(TubeShopItem, _super);
      function TubeShopItem() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.checkIcon = null;
        _this._tubeIndex = 0;
        _this._isChecked = false;
      ...
      Object.defineProperty(TubeShopItem.prototype, "tubeIndex", {
        get: function() {
          return this._tubeIndex;
        },
        set: function(value) {
          this._tubeIndex = value;
        },
        enumerable: false,
        configurable: true
      });
      Object.defineProperty(TubeShopItem.prototype, "isChecked", {
        get: function() {
          return this._isChecked;
        },
        set: function(isChecked) {
      ...
      TubeShopItem.prototype.onLoad = function() {
        this.node.on(cc.Node.EventType.TOUCH_END, this.onItemTouch, this);
      };
      TubeShopItem.prototype.onItemTouch = function(event) {
        this.node.parent.getComponent(TubeShopPanel_1.default).setTube(this.tubeIndex);
      };
      TubeShopItem.prototype.start = function() {};
      __decorate([ property(cc.Node) ], TubeShopItem.prototype, "checkIcon", void 0);
      TubeShopItem = __decorate([ ccclass ], TubeShopItem);
      return TubeShopItem;
    }(cc.Component);
    exports.default = TubeShopItem;
    cc._RF.pop();
  }, {
    "./TubeShopPanel": "TubeShopPanel"
  } ],
  TubeShopPanel: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "79da5zT5CpLJaEPkWs60Y2f", "TubeShopPanel");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var Global_1 = require("./Global");
    var TubeShopItem_1 = require("./TubeShopItem");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var TubeShopPanel = function(_super) {
      __extends(TubeShopPanel, _super);
      function TubeShopPanel() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.itemList = [];
        _this._currentTubeIndex = -1;
        return _this;
      }
      TubeShopPanel.prototype.onLoad = function() {
        for (var i = 0; i < this.node.children.length; i++) {
          var tubeItem = this.node.children[i].getComponent(TubeShopItem_1.default);
          tubeItem.tubeIndex = i;
          this.itemList.push(tubeItem);
        }
        var tubeID = Global_1.Global.getInstance().userData.bottleID;
        this.setTube(tubeID);
      };
      TubeShopPanel.prototype.setTube = function(index) {
        if (index === this._currentTubeIndex) return;
        for (var i = 0; i < this.itemList.length; i++) this.itemList[i].isChecked = index === i;
        Global_1.Global.getInstance().inGame.setBottle(index);
        this._currentTubeIndex = index;
      };
      TubeShopPanel.prototype.start = function() {};
      TubeShopPanel = __decorate([ ccclass ], TubeShopPanel);
      return TubeShopPanel;
    }(cc.Component);
    exports.default = TubeShopPanel;
    cc._RF.pop();
  }, {
    "./Global": "Global",
    "./TubeShopItem": "TubeShopItem"
  } ],
  VibrateSlipRadioBtn: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "033fcQhvHJCHKmG4irV2BLz", "VibrateSlipRadioBtn");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var Global_1 = require("../Global");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var VibrateSlipRadioBtn = function(_super) {
      __extends(VibrateSlipRadioBtn, _super);
      function VibrateSlipRadioBtn() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.slipNode = null;
        _this.offPos = 0;
        _this.onPos = 0;
      ...
      Object.defineProperty(VibrateSlipRadioBtn.prototype, "status", {
        get: function() {
          return this._status;
        },
        set: function(value) {
      ...
      VibrateSlipRadioBtn.prototype.onLoad = function() {
        this.slipNode.on(cc.Node.EventType.TOUCH_START, this.onTouchSlipNode, this);
      };
      VibrateSlipRadioBtn.prototype.onTouchSlipNode = function(event) {
        this.status = !this.status;
      };
      VibrateSlipRadioBtn.prototype.start = function() {
        this.initData();
      };
      VibrateSlipRadioBtn.prototype.initData = function() {
        this._status = Global_1.Global.getInstance().userData.vibrate;
        this.initUI();
      };
      VibrateSlipRadioBtn.prototype.initUI = function() {
        this.status ? this.slipNode.x = this.onPos : this.slipNode.x = this.offPos;
      };
      VibrateSlipRadioBtn.prototype.updateData = function() {
        Global_1.Global.getInstance().userData.vibrate = this.status;
      };
      __decorate([ property(cc.Node) ], VibrateSlipRadioBtn.prototype, "slipNode", void 0);
      __decorate([ property ], VibrateSlipRadioBtn.prototype, "offPos", void 0);
      __decorate([ property ], VibrateSlipRadioBtn.prototype, "onPos", void 0);
      VibrateSlipRadioBtn = __decorate([ ccclass ], VibrateSlipRadioBtn);
      return VibrateSlipRadioBtn;
    }(cc.Component);
    exports.default = VibrateSlipRadioBtn;
    cc._RF.pop();
  }, {
    "../Global": "Global"
  } ]
}, {}, [ "AssistiveButton", "BgShopItem", "BgShopPanel", "Bottle", "DropWater", "Game", "GameLevels", "Global", "InGame", "LevelItem", "LevelPanel", "Loading", "MenuTabPanel", "Shop", "Solution", "Tools", "TubeShopItem", "TubeShopPanel", "SoundSlipRadioBtn", "VibrateSlipRadioBtn" ]);